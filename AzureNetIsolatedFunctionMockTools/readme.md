...
```csharp
var context = new MockFunctionContext();
var response = new MockHttpResponseData(
    functionContext: context,
...
var serviceProvider = new MockServiceProvider(services);
var context = new MockFunctionContext(instanceServices: serviceProvider);
```
